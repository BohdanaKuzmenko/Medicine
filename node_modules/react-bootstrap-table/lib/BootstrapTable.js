...
var BootstrapTable = (function (_Component) {
  ...
  function BootstrapTable(props) {
    ...
    this.updateAddedData = function (newObj) {
      _this.props.addNewObj(newObj);
    };
    ...
    this.updateDeletedData = function (keys) {
      _this.props.deleteObjects(keys);
    };
    ...
    this.handleDropRow = function (rowKeys) {
      ...
      if (dropRowKeys && dropRowKeys.length > 0) {
        if (_this.props.options.handleConfirmDeleteRow) {
          ...
          _this.deleteRow(dropRowKeys);
          _this.updateDeletedData(dropRowKeys);
        }
      }
    };
